...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://razer:razer@leechmoye.r1uuh.mongodb.net/?retryWrites=true&w=majority&appName=leechmoye")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "moviebase")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'moviebase')
